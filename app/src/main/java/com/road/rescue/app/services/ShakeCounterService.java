...
import com.road.rescue.app.activities.CounterActivity;
...
public class ShakeCounterService extends Service implements ShakeDetector.Listener {
    @Nullable
    @Override
    ...
    public void hearShake() {
        ...
        if (SharedPrefUtils.getBooleanData(getApplicationContext(), "isLogin")) {
            if (SharedPrefUtils.getBooleanData(getApplicationContext(), "isCounter")) {
                    ...
                    Intent intent1 = new Intent(getApplicationContext(), CounterActivity.class);
